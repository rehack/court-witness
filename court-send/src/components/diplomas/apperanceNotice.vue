         ...
         <div class="main">
            <Row>
                ...
                <div class="lineHeight">
                     &emsp;&emsp;
                    <div style="width: 35%; display:inline-block;border-bottom:1px solid black;text-align: center;"><input type="text" v-model="backFill.plaintiffName"></div>
                    与<div style="width: 35%; display:inline-block;border-bottom:1px solid black;text-align: center;"><input type="text" v-model="backFill.defendantNameBriefName"></div>
                    一案，本院已立案。现将应诉的有关事项通知如下：
                </div>
                <div class="textIndent">一、在诉讼过程中，当事人必须依法行使诉讼权利，有权行使《中华人民共和国民事诉讼法》第四十九条、第五十条、第五十一条等规定的诉讼权利，同时也必须遵守诉讼秩序，履行诉讼义务。</div>
                <div class="textIndent">二、在收到起诉状副本后十五日内向本院提交答辩状，并按对方当事人的人数提出副本。</div>
                <div class="textIndent">三、自然人应当提交身份证或者通行证、护照复印件；法人或者其他组织应当提交营业执照或者事业单位法人代码证复印件、法定代表人或者主要负责人身份证明书。</div>
                <div class="textIndent">四、当事人、法定代理人可以委托一至二人作为诉讼代理人。</div>
                ...
                <div class="textIndent">
                   五、根据《最高人民法院关于人民法院在互联网公布裁判文书的规定》，本院作出的生效裁判文书将在中国裁判文书网上公布。如果你认为案件涉及个人隐私或商业秘密，申请对裁判文书中的有关内容进行技术处理或者申请不予公布的，至迟应在裁判文书送达之日起三日内以书面形式提出并说明具体理由。
                   经本院审查认为理由正当的，可以在公布裁判文书时隐去相关内容或不予公布。
                </div>
